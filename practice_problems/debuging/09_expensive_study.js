...
// The issue with the code has to do with the way that amount is defined.  As the code was written if amount evaluates to a falsey value, then amount is assigned to the value of one. Since `0` evaluates as falsey, when a user attempts to set the value of pencils to 0, the number of pencils is assigned to 1.  In order to change this, we can set up a condition to handle the number 0 appropriately.